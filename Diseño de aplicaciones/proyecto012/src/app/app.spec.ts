    ...
    if (this.formAlumno.value.notas) {
      if (this.formAlumno.value.notas.nota1 &&
        ...
        if (nota1 >= 4 && nota2 >= 4 && nota3 >= 4)
          this.resultado = "El alumno queda aprobado por esas notas" + " " + this.formAlumno.value.nombre;
        else
          this.resultado = "El alumno no aprueba por esas notas"+ " " + this.formAlumno.value.nombre;
      }
    }
  }
}
